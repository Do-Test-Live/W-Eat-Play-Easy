    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">Invoices</h2>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    ...
                                    <span class="fs-18">Total Invoices</span>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    ...
                                    <span class="fs-18">Paid Invoices</span>
                                </div>
                                <span class="p-3 border ml-3 rounded-circle">
										<svg width="34" height="34" viewBox="0 0 34 34" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    ...
                                    <span class="fs-18">Total Unpaid Invoices</span>
                                </div>
                                <span class="p-3 border ml-3 rounded-circle">
										<svg width="34" height="34" viewBox="0 0 34 34" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
