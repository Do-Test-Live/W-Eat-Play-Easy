    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">Blog</h2>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    <h2 class="fs-38 text-black font-w600"><?php
                                        $blog_no = $db_handle->numRows("SELECT * FROM `blog`");
                                        if($blog_no > 0){
                                            echo $blog_no;
                                        } else {
                                            echo '0';
                                        ...
                                        ?></h2>
                                    <span class="fs-18">Total Blog</span>
                                </div>
